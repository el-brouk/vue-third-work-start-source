  ...
  <main class="content">
    <section class="desk">
      ...
      <div class="desk__header">
        ...
        <button class="desk__add" type="button" @click="columnsStore.addColumn">Добавить столбец</button>
            ...
            <ul class="user-filter">
              ...
              >
                <a class="user-filter__button">
                  <img :src="getPublicImage(user.avatar)" alt="Аватар юзера" width="24" height="24" />
                </a>
              </li>
            </ul>
          </div>
