<template>
  <div class="task-card" tabindex="0" ref="dialog" @click.self="closeDialog" @keydown.esc="closeDialog">
    <section class="task-card__wrapper">
      ...
      <div class="task-card__block">
        <div class="task-card__row">
          ...
          <input v-model="task.title" type="text" name="task_name" class="task-card__name" max="37" />
          <!--          Кнопка удаления задачи-->
          <a v-if="taskToEdit" class="task-card__edit task-card__edit--red" @click="deleteTask"> Удалить Задачу </a>
        </div>
      ...
      <div class="task-card__status">
        ...
        <ul class="meta-filter task-card__meta">
          ...
          >
            <a class="meta-filter__status" :class="`meta-filter__status--${value}`" :title="label" />
          </li>
        </ul>
      </div>
      ...
      <div class="task-card__block">
        <div class="task-card__description">
          ...
          <textarea v-model="task.description" name="task_description" placeholder="Добавьте описание к задаче" />
        </div>
      </div>
      <!--      Блок внешней ссылки-->
      <div class="task-card__block">
