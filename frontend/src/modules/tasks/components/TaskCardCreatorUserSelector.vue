<template>
  <li>
    ...
    <div class="task-card__participant">
      <button v-if="!modelValue" type="button" class="task-card__link" @click.stop="isMenuOpened = !isMenuOpened">
        добавить пользователя
      </button>
      <button v-else class="users-list__user">
        <img :src="getPublicImage(currentWorker.avatar)" @click.stop="isMenuOpened = !isMenuOpened" />
